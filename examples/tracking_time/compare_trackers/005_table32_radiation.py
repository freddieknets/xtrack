...
if TRACK_CPU_SINGLE:
    ...
    line_cpu_single.configure_radiation(model = "quantum-efficient-table32")
...
if TRACK_CPU_OPENMP:
    ...
    line_cpu_openmp.configure_radiation(model = "quantum-efficient-table32")
...
if TRACK_GPU_CUPY:
    ...
    line_gpu_cupy.configure_radiation(model = "quantum-efficient-table32")
...
fig.suptitle(f"Tracking Time Comparison (Quantum Efficient Table 32 Radiation) - {N_TURNS} Turns")
