...
if TRACK_NONE:
    ...
    line_none.build_tracker(_context = CONTEXT_GPU_CUPY)
...
if TRACK_MEAN:
    ...
    line_mean.build_tracker(_context = CONTEXT_GPU_CUPY)
...
if TRACK_QUANTUM:
    ...
    line_quantum.build_tracker(_context = CONTEXT_GPU_CUPY)
...
if TRACK_EFFICIENT:
    ...
    line_efficient.build_tracker(_context = CONTEXT_GPU_CUPY)
...
if TRACK_TABLE32:
    ...
    line_table32.build_tracker(_context = CONTEXT_GPU_CUPY)
...
if TRACK_TABLE32DIRECT:
    ...
    line_direct.build_tracker(_context = CONTEXT_GPU_CUPY)
...
fig.suptitle(f"Tracking Time Comparison (GPU CuPy) - {N_TURNS} Turns")
